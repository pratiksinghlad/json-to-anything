...
}`,T=()=>{let{t:e}=s(),[n,a]=(0,_.useState)(C),[h,g]=(0,_.useState)(w),{leftPanelRef:v,rightPanelRef:y}=d(),{isValid:b,errors:T}=(0,_.useMemo)(()=>{if(f(n)||f(h))return{isValid:!1,errors:[]};let t=m(n);if(!t.success)return{isValid:!1,errors:[{path:``,message:`${e(`pages.validate.invalidJson`)}: ${t.error}`,line:t.line}]};let r=m(h);if(!r.success)return{isValid:!1,errors:[{path:``,message:`${e(`pages.validate.invalidSchema`)}: ${r.error}`,line:r.line}]};let i=x(t.data,r.data,{jsonString:n});return{isValid:i.valid,errors:i.errors??[]}},[n,h,e]);return(0,S.jsx)(l,{leftPanel:(0,S.jsx)(c,{ref:v,title:e(`pages.validate.jsonData`),value:n,onChange:a,language:`json`}),centerPanel:(0,S.jsx)(u,{}),rightPanel:(0,S.jsx)(c,{ref:y,title:e(`pages.validate.jsonSchema`),value:h,onChange:g,language:`json`}),bottomPanel:(0,S.jsxs)(t,{sx:{p:2},children:[(0,S.jsx)(r,{variant:`h6`,sx:{mb:2},children:e(`pages.validate.results`)}),b&&T.length===0&&(0,S.jsx)(t,{sx:{display:`flex`,alignItems:`center`,gap:1,mb:2},children:(0,S.jsx)(o,{icon:(0,S.jsx)(i,{}),label:e(`pages.validate.valid`),color:`success`,variant:`filled`})}),(0,S.jsx)(p,{errors:T})]})})};export{T as default};