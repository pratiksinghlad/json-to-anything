import { t as __commonJSMin } from "./rolldown-runtime-BM52pwkw.js";
var require_prism = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	var Prism$1 = function(_self) {
		...
		var _ = {
			...
			languages: {
				...
				extend: function(id, redef) {
					var lang$1 = _.util.clone(_.languages[id]);
		...
		if (!_self.document) {
			...
			if (!_.disableWorkerMessageHandler) _self.addEventListener("message", function(evt) {
				...
				var lang$1 = message.language;
				var code = message.code;
				var immediateClose = message.immediateClose;
				_self.postMessage(_.highlight(code, _.languages[lang$1], lang$1));
	...
	if (typeof module !== "undefined" && module.exports) module.exports = Prism$1;
	...
	(function(Prism$2) {
		...
		var markup = Prism$2.languages.markup;
		if (markup) {
	...
	(function() {
		if (typeof Prism$1 === "undefined" || typeof document === "undefined") return;
		...
		Prism$1.plugins.fileHighlight = { highlight: function highlight(container) {
			var elements = (container || document).querySelectorAll(SELECTOR);
			for (var i = 0, element; element = elements[i++];) Prism$1.highlightElement(element);
		} };
		var logged = false;
