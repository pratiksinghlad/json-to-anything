...
}`,v=()=>{let{t:e}=o(),[n,a]=(0,h.useState)(_),[v,y]=(0,h.useState)(``),[b,x]=(0,h.useState)([]),{leftPanelRef:S,rightPanelRef:C}=u(),{convert:w,isProcessing:T}=m();return(0,h.useEffect)(()=>{if(f(n)){x([]),y(``);return}let e=!1;return(async()=>{try{JSON.parse(n)}catch(t){e||(x([{message:t instanceof Error?t.message:String(t)}]),y(``));return}let t=await w(n,`yaml`);e||(t.ok?(y(t.output),x([])):(y(``),x([{message:t.error}])))})(),()=>{e=!0}},[n,w]),(0,g.jsx)(c,{leftPanel:(0,g.jsx)(s,{ref:S,title:e(`common.json`),value:n,onChange:a,language:`json`}),centerPanel:(0,g.jsx)(l,{}),rightPanel:(0,g.jsx)(s,{ref:C,title:`YAML`,value:v,language:`yaml`,readOnly:!0}),bottomPanel:(0,g.jsxs)(i,{sx:{p:2},children:[T&&(0,g.jsxs)(i,{sx:{mb:2},children:[(0,g.jsx)(t,{}),(0,g.jsx)(r,{variant:`caption`,color:`text.secondary`,sx:{mt:.5},children:e(`pages.jsonToToon.processing`)})]}),(0,g.jsx)(d,{errors:b}),(0,g.jsx)(i,{sx:{mt:2,display:`flex`,gap:2,alignItems:`center`,flexWrap:`wrap`},children:(0,g.jsx)(p,{yamlData:v,jsonData:n,disabled:!v})})]})})};export{v as default};