import{a as e}from"./rolldown-runtime-CaomFzHi.js";import{C as t,G as n,I as r,L as i,M as a,P as o,S as s,U as c,n as l,t as u,x as d}from"./mui-vendor-JnOqsSZ-.js";import{s as f}from"./react-vendor-C089BLRD.js";import"./Header-CgTDQZhI.js";import{n as p,r as m,t as h}from"./JsonEditorLayout-DlUJzykU.js";import{n as g,t as _}from"./vendor-Dhg1wUZS.js";import{t as v}from"./parseJson-M88Op6kn.js";var y=e(n()),b=e(g()),x=e(_());function S(e,t,n){if(e==null)return{valid:!1,errors:[{path:``,message:`Input is null or undefined`}]};if(t==null)return{valid:!1,errors:[{path:``,message:`Schema is null or undefined`}]};if(typeof t!=`object`)return{valid:!1,errors:[{path:``,message:`Schema must be an object`}]};try{let r=n?.schemaDraft,i={allErrors:!0,verbose:!0,strict:!1};(r===`draft-04`||r===`draft-06`)&&(i={...i,validateSchema:!1});let a=new b.default(i);(0,x.default)(a);let o=a.compile(t);return o(e)?{valid:!0}:{valid:!1,errors:(o.errors||[]).map(e=>({path:e.instancePath||``,message:e.message||`Unknown validation error`}))}}catch(e){return{valid:!1,errors:[{path:``,message:e instanceof Error?e.message:String(e)}]}}}var C=e(c()),w=`{
  "name": "Alice Example",
  "age": 30,
