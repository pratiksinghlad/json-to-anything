...
}`,w=()=>{let{t:e}=s(),[r,o]=(0,g.useState)(S),[d,f]=(0,g.useState)(C),[_,v]=(0,g.useState)(!1),[y,w]=(0,g.useState)([]);return(0,g.useEffect)(()=>{if(h(r)||h(d)){v(!1),w([]);return}let t=m(r);if(!t.success){v(!1),w([{path:``,message:`${e(`pages.validate.invalidJson`)}: ${t.error}`,line:t.line}]);return}let n=m(d);if(!n.success){v(!1),w([{path:``,message:`${e(`pages.validate.invalidSchema`)}: ${n.error}`,line:n.line}]);return}let i=b(t.data,n.data,{jsonString:r});v(i.valid),w(i.errors??[])},[r,d,e]),(0,x.jsx)(u,{leftPanel:(0,x.jsx)(l,{title:e(`pages.validate.jsonData`),value:r,onChange:o,language:`json`}),centerPanel:(0,x.jsx)(c,{}),rightPanel:(0,x.jsx)(l,{title:e(`pages.validate.jsonSchema`),value:d,onChange:f,language:`json`}),bottomPanel:(0,x.jsxs)(a,{sx:{p:2},children:[(0,x.jsx)(n,{variant:`h6`,sx:{mb:2},children:e(`pages.validate.results`)}),_&&y.length===0&&(0,x.jsx)(a,{sx:{display:`flex`,alignItems:`center`,gap:1,mb:2},children:(0,x.jsx)(t,{icon:(0,x.jsx)(i,{}),label:e(`pages.validate.valid`),color:`success`,variant:`filled`})}),(0,x.jsx)(p,{errors:y})]})})};export{w as default};