...
# Frontend Excellence: React, TypeScript, & mui UI
...
- Use **mui UI components** for all layout and UI needs.
- **Style Props**: Prefer mui's style props (e.g., `px={4}`, `bg="blue.500"`) over external CSS or inline styles.
